...
# POLYWINS
# IMPORT PYWAL COLORS
. "/home/lenan/.cache/wal/colors.sh"

# SETTINGS {{{ ---

active_text_color="$color6"
active_bg=
active_underline="$color6"

inactive_text_color="#dfcccccc"
inactive_bg=
inactive_underline=

separator=" / "
show="window_classtitle" # options:window_classtitle, window_title, window_class, window_classname
